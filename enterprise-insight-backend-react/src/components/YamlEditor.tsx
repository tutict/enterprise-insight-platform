...
export default function YamlEditor({
  ...
  return (
    <div
      className="relative overflow-hidden rounded-lg border border-white/10 bg-console-950 shadow-inner focus-within:border-teal-400/60 focus-within:ring-2 focus-within:ring-teal-400/10"
      style={{ minHeight }}
    >
      ...
      <pre
        aria-hidden="true"
        className="pointer-events-none absolute inset-0 z-0 min-w-max overflow-hidden py-4 pl-[4.75rem] pr-4 text-xs leading-6"
      ...
      <textarea
        className="relative z-10 block w-full resize-y overflow-auto whitespace-pre bg-transparent py-4 pl-[4.75rem] pr-4 text-xs leading-6 text-transparent caret-teal-300 outline-none selection:bg-teal-400/25 placeholder:text-slate-600"
        style={{ minHeight }}
        value={value}
